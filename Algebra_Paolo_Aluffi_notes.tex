...
\uuline{Products and Coproducts of Categories}:\retTwo

Let $\mcateg{C}$ be a category and $A$ and $B$ be objects in $\mcateg{C}$. Similar to how we defined $\mcateg{C}_A$ and\\ $\mcateg{C}^A$ earlier, we can define $\mcateg{C}_{A,B}$ and $\mcateg{C}^{A,B}$ as follows:\\ [-14pt]
\begin{myIndent}\hTwo
   {\begin{tabular}{ p{5.8in} }
      \\\hline
      \\
      {\centering $\mcateg{C}_{A,B}$ \par}\\ [-54pt]
      \hThree
      \begin{tabular}{ p{3.75in}p{1.85in}}
         \raisebox{-4.7em}{\begin{tabular}{p{3.7in}}
            $\myObj(\mcateg{C}_{A,B}) = $ all diagrams of the form to the  right\newline where $Z$ is an object in $\mcateg{C}$, $f \in \myHom_\mcateg{C}(Z, A)$ and\newline $g \in \myHom_\mcateg{C}(Z, B)$.\newline
         \end{tabular}}
         &
         % https://q.uiver.app/#q=WzAsMyxbMCwxLCJaIl0sWzIsMiwiIEEiXSxbMiwwLCJCIl0sWzAsMSwiZiIsMl0sWzAsMiwiZyJdXQ==
      ...
      \begin{tabular}{ p{5.6in}}
         \begin{tabular}{ p{5.5in}}
            A morphism from 
            % https://q.uiver.app/#q=WzAsMyxbMCwxLCJaXzEiXSxbMiwyLCIgQSJdLFsyLDAsIkIiXSxbMCwxLCJmXzEiLDJdLFswLDIsImdfMSJdXQ==
            \begin{tikzcd}[row sep=small]
               && A \\
               {Z_1} \\
               && { B}
               \arrow["{g_1}"', from=2-1, to=3-3]
               \arrow["{f_1}", from=2-1, to=1-3]
            \end{tikzcd}
            to 
            \begin{tikzcd}[row sep=small]
               && A \\
            ...
            \end{tikzcd}\\ [48pt]
            is a morphism $\sigma \in \myHom_\mcateg{C}(Z_1, Z_2)$ such that $f_2 \sigma = f_1$ and $g_2 \sigma = g_1$.
         \end{tabular}
      \end{tabular}
   \end{tabular}}
   \newpage
   {\begin{tabular}{ p{5.8in} }
      ...
      \begin{tabular}{ p{5.6in}}
         \begin{tabular}{ p{5.5in}}
            In other words, a morphism of $\mcateg{C}_{A,B}$ is a commutative diagram:

            {\center
            % https://q.uiver.app/#q=WzAsNCxbMiwxLCJaXzIiXSxbNCwyLCIgQSJdLFs0LDAsIkIiXSxbMCwxLCJaXzEiXSxbMCwxLCJmXzIiXSxbMCwyLCJnXzIiLDJdLFszLDEsImZfMSIsMix7ImN1cnZlIjoxfV0sWzMsMiwiZ18xIiwwLHsiY3VydmUiOi0xfV0sWzMsMCwiXFxzaWdtYSJdXQ==
            \begin{tikzcd}
               &&&& A \\
               {Z_1} && {Z_2} \\
               &&&& { B}
               \arrow["{g_2}", from=2-3, to=3-5]
               \arrow["{f_2}"', from=2-3, to=1-5]
               \arrow["{g_1}"', curve={height=6pt}, from=2-1, to=3-5]
               \arrow["{f_1}", curve={height=-6pt}, from=2-1, to=1-5]
      ...
      \\ \hline
      \\
      {\centering $\mcateg{C}^{A,B}$ \par}\\ [-24pt]
      \hThree
      \begin{tabular}{ p{3.75in}p{1.85in}}
         \raisebox{-1.6em}{\begin{tabular}{p{3.7in}}
            $\myObj(\mcateg{C}^{A,B}) = $ all diagrams of the form to the  right\newline where $Z$ is an object in $\mcateg{C}$, $f \in \myHom_\mcateg{C}(A, Z)$ and\newline $g \in \myHom_\mcateg{C}(B, Z)$.\newline
         \end{tabular}}
         &
         % https://q.uiver.app/#q=WzAsMyxbMiwxLCJaIl0sWzAsMiwiIEEiXSxbMCwwLCJCIl0sWzEsMCwiZiIsMl0sWzIsMCwiZyJdXQ==
         \begin{tikzcd}[row sep=small]
            A \\
            && Z \\
            { B}
      ...
      \begin{tabular}{ p{5.6in}}
         \begin{tabular}{ p{5.5in}}
            A morphism from 
            % https://q.uiver.app/#q=WzAsMyxbMiwxLCJaXzEiXSxbMCwyLCIgQSJdLFswLDAsIkIiXSxbMSwwLCJmXzEiLDJdLFsyLDAsImdfMSJdXQ==
            \begin{tikzcd}[row sep=small]
               A \\
               && {Z_1} \\
               {B}
            ...
            \begin{tikzcd}[row sep=small]
               ...
               && {Z_2} \\
               {B}
               \arrow["{g_2}"', from=3-1, to=2-3]
               \arrow["{f_2}", from=1-1, to=2-3]
            \end{tikzcd}\\ [48pt]
            is a morphism $\sigma \in \myHom_\mcateg{C}(Z_1, Z_2)$ such that $f_2 = \sigma f_1$ and $g_2 = \sigma g_1$.\retTwo

            In other words, a morphism of $\mcateg{C}^{A,B}$ is a commutative diagram:

            {\center
            % https://q.uiver.app/#q=WzAsNCxbMiwxLCJaXzEiXSxbMCwyLCIgQSJdLFswLDAsIkIiXSxbNCwxLCJaXzIiXSxbMSwwLCJmXzEiXSxbMiwwLCJnXzEiLDJdLFsxLDMsImZfMiIsMix7ImN1cnZlIjoxfV0sWzIsMywiZ18yIiwwLHsiY3VydmUiOi0xfV0sWzAsMywiXFxzaWdtYSIsMl1d
            \begin{tikzcd}
               A \\
               && {Z_1} && {Z_2} \\
               {B}
               \arrow["{g_1}", from=3-1, to=2-3]
               \arrow["{f_1}"', from=1-1, to=2-3]
               \arrow["{g_2}"', curve={height=6pt}, from=3-1, to=2-5]
               \arrow["{f_2}", curve={height=-6pt}, from=1-1, to=2-5]
...
\begin{enumerate}
   ...
   {\centering % https://q.uiver.app/#q=WzAsMyxbMCwxLCJBXFx0aW1lcyBCIl0sWzIsMiwiIEIiXSxbMiwwLCJBIl0sWzAsMSwiXFxwaV9CIiwyXSxbMCwyLCJcXHBpX0EiXV0=
   \begin{tikzcd}[row sep=small]
      && A \\
      {A\times B} \\
      && { B}
   ...
   {\begin{myIndent} \exTwo
      ...
      \begin{tikzcd}
         ...
         \arrow["{f_B}"', curve={height=6pt}, from=2-1, to=3-5]
         \arrow["{f_A}", curve={height=-6pt}, from=2-1, to=1-5]
         \arrow["\sigma", from=2-1, to=2-3]
      \end{tikzcd}\par}
...
\begin{enumerate}
   ...
   {\begin{myIndent} \exTwo
      ...
      \begin{tikzcd}
         ...
         \arrow["{i_B}", from=3-1, to=2-3]
         \arrow["{i_A}"', from=1-1, to=2-3]
         \arrow["{f_B}"', curve={height=6pt}, from=3-1, to=2-5]
         \arrow["{f_A}", curve={height=-6pt}, from=1-1, to=2-5]
         \arrow["\sigma"', from=2-3, to=2-5]
      \end{tikzcd}\par}
...
% Exercise Problem if I feel like it...

More generally, if $\mathscr{S}$ is a set of sets, then we can define:

{\centering ${\displaystyle \prod\limits_{S \in \mathscr{S}}S}$ and ${\displaystyle \coprod\limits_{S \in \mathscr{S}}S}$ \par}

as the product and disjoint union respectively of all sets in $\mathscr{S}$.
