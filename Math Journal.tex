...
\end{tabular} \retTwo\par}
		...
		\begin{myIndent}\pracTwo\fontsize{11}{13}
			...
			{\centering $\int_0^\infty \frac{\sin(y)}{y}e^{-sy}\df y = \int_{-\infty}^\infty \mathcal{F}(\frac{\sin(y)}{y})\overline{\mathcal{F}(e^{-sy})} \df y$\newpage\par}
...
Today I'm gonna do more problems from chapter 8 of Folland.
