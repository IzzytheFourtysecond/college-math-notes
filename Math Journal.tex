...
% a section of E. [Hint: Choose e0 ∈ E. Define h : J → E by the recursion
% formula
% h(α) = smallest [E − h(Sα)] if h(Sα) != E,
% and h(α) = e0 otherwise
