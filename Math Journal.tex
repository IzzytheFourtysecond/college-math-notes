...
Firstly, I'm going to finish describing $C_0(X)^*$.\retTwo
...
\begin{myIndent}\exOne
	...
	\begin{myIndent}\exTwoP
		Proof:\\
		We already have shown that every $I \in C_0(X)^*$ is of the form $I_\mu$ for some $\mu \in M(X)$. On the other hand, if $\mu \in M(X)$, then we already know that $I_\mu$ is a linear function. Also, by proposition 3.13: $|\int f \df \mu| \leq \int |f|\df |\mu| \leq \|f\|_u\|\mu\|$. So, $I_\mu$ is bounded with $\|I_\mu\| \leq \|\mu\|$.\retTwo
