...
\exTwo\ul{Proposition 10.1:} If $f: \Omega^\prime \to \mathbb{R}$ is a random variable, then $\int f \df P_\phi = \int (f \circ \phi) \df P$\\ whenever either side exists.
...
\exTwo\ul{Proposition 10.4:} If $X_1, \ldots, X_n$  are independent random variables, then:
...
\hTwo I next want to cover two other miscellaneous results.\retTwo
