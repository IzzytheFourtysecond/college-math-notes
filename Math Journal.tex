...
\blab{Exercise 5:} Let $X$ be a set and let $\mathcal{A}$ be the collection of all pairs $(A, <)$ where $A$ is a subset of $X$ and $<$ is a well-ordering of $A$. Define:
...
\begin{itemize}
   ...
   \begin{myIndent}\exTwoP
      Clearly no $A$ is a section of itself. So $(A, <) \not\prec (A, <)$. Also if $(A, <_A) \prec (B, <_B) \prec (C, <_C)$, then we know that $A$ is a section of a section (which is still a section.) Plus, $<_A$ is just $<_C$ restricted to $<_A$. Hence, $(A, <) \prec (C, <_C)$.\newpage
   \end{myIndent}
   ...
   \begin{myIndent}\myComment
      In other words, we need to show that $B^\prime$ is well-ordered by $<^\prime$.\retTwo
