...
\begin{itemize}
	...
	\begin{myIndent}\exThreeP
		...
		\myComment Note from 9/4/2025: Fuck I thought of a way clearner proof for this. I'll write it below.\retTwo
...
\begin{myIndent}
	...
	Moreover, $x \mapsto \int f_x \df \nu$ and $y \mapsto \int f^y \df \mu$ are measurable for a.e. $x$ and a.e. $y$. And in the case that (b) is true they are also integrable for a.e. $x$ and a.e. $y$.\retTwo
