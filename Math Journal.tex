...
\begin{myIndent}\hThree
	It's clear that $\mu \times \nu$ is a well-defined Radon measure on $M(\mathbb{R}^n \times \mathbb{R}^n)$ by propostion 7.16 (page 59 of my journal), propositions 7.20(c) (page 182 of my journal), and the corollary to exercise 7.8 (page 154 of my journal).
\end{myIndent}
