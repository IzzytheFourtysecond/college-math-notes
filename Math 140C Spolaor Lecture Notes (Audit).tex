...
{\begin{myIndent} \hTwo
   ...
   \begin{itemize}
      ...
      {\begin{myIndent}\hThree
         Proof:\\
         Firstly, by the previous theorem we know that for any $\mMat{A} \in \Omega$,\\ if $r = \frac{1}{\|\mMat{A}^{-1}\|}$, then $B_r(\mMat{A}) \subseteq \Omega$. So $\Omega$ is an open set in the metric\\ space $L(\mathbb{R}^n)$.
      \end{myIndent}}
