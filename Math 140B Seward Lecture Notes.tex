...
{\begin{myIndent}\hTwo
   ...
   {\begin{myIndent}\hThree
      ...
      {\begin{myIndent}\hFour
         ...
         Then, if there exists $(P_n)$ converging uniformly to $g$ on $[0, 1]$, we know\\ that $P_n(\frac{x-a}{b-a}) + f(a) + \frac{x-a}{b-a}(f(b) - f(a))$ converges uniformly on\\ $[a, b]$ to $g(\frac{x-a}{b-a}) + f(a) + \frac{x-a}{b-a}(f(b)-f(a)) = f(x)$
      \end{myIndent}}
