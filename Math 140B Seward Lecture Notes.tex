...
{\begin{myIndent}\pracTwo
   ...
   Then by theorem 9.15 (proposition 92), we know that $\exists s \in (0, 1)$ such that\\ [2pt] $f(1) = P(1) + \frac{f^\ppprime(s)}{6}x^3 = \frac{f^\pprime(0)}{2} + \frac{f^\ppprime(s)}{6}$. Similarly, we know that $\exists t \in (-1, 0)$\\ [2pt] such that $f(-1) = \frac{f^\pprime(0)}{2} - \frac{f^\ppprime(t)}{6}$.\retTwo
...
{\begin{myIndent}\pracTwo
   ...
   \begin{myIndent}
      ...
      Therefore, for $x_0 \in [\gamma, \gamma + \frac{1}{A}) \cap [\gamma, b]$, we have that $\hspace{-0.45em}\sup\limits_{\gamma\leq x\leq x_0}\hspace{-0.4em}|f(x)| = 0$.\retTwo
