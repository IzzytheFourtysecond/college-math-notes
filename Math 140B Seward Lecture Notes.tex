...
Claim: for all $n \in \mathbb{Z}^+$, if $f(x) = x^n$, then $f^\prime(x) = nx^{n-1}$.\\ [-10pt]
...
This combined with proposition 84 tells us that both polynomials and\\ rational functions are differentiable over their domains.
...
\begin{allowTableDashes}
   \begin{tabular}{ c|c||c|c }
      ...
      \myVS 85 & 5.5 & 86 &  \\ \hdashline[10pt/3pt]
      \myVS 87 &  & 88 &  \\ \hdashline[10pt/3pt]
      \myVS 89 &  & 90 &  \\ \hdashline[10pt/3pt]
