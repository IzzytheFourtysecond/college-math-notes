...
\begin{myIndent}
   Firstly, given a partition $P$ with $n + 1$ points, we write $\Delta x_i = x_i - x_{i-1}$\\ for each $i \in \{1, \ldots, n\}$.\retTwo
...
\begin{myIndent}\exTwo
   ...
   So, $\underline{\int_a^b}fdx$ and $\overline{\int_a^b}fdx$ are always defined.
\end{myIndent}
