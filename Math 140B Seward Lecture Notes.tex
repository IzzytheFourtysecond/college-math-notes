...
As a consequence of $f$ being strictly increasing, we know $f$ is injective. Thus if we\\ restrict the codomain of $f$ to $f((a, b))$, then $f$ is bijective, meaning there exists a\\ function $g = f^{-1}$ such that $(g \circ f)(x) = x = (f \circ g)(x)$.% We shall show that the\\ domain of $g$ is some open interval $(c, d)$.
