...
\begin{myIndent}\hTwo
	...
	\blab{Chinese Remainder Theorem:} Suppose $r, s$ are coprime positive integers. Then the map $\mathbb{Z} / (rs)\mathbb{Z} \longrightarrow (\mathbb{Z} / r\mathbb{Z}) \times (\mathbb{Z} / s\mathbb{Z})$ given by $a + rs\mathbb{Z} \mapsto (a + r\mathbb{Z}, a + s\mathbb{Z})$ is an isomorphism.
