...
\begin{document}
   ...
   Similarly, we define the \udefine{left-hand limit} of $f$ at $x$ and denote this $f(x-)$ or $\lim\limits_{t\rightarrow x^-}f(t)$ to be $\lim\limits_{t\rightarrow x}h(t)$ where $h$ is the restriction of $f$ to $(a, x)$.\retTwo
