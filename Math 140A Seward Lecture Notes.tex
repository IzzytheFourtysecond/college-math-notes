...
\begin{document}
   ...
   \begin{myIndent}
      ...
      Then we define the Cantor set as $C = {\displaystyle \bigcap_{i=0}^n{C_i}}$. \retTwo
   ...
   {\begin{myIndent} \exOne
      ...
      \begin{enumerate}
         ...
         {\begin{myIndent} \hThree
            Proof:\\
            Since $(p_n)$ is Cauchy, pick $N$ with $\diam{\{p_N, p_{N+1}, \ldots\}} < 1$. Setting\\ $r = \max\{1, d(p_1, p_N), \ldots, d(p_{N-1}, p_N)\}$, we have that for all $n$,\\ $d(p_n, p_N) \leq r$. So $(p_n)$ is bounded.
            \retTwo
         \end{myIndent}}
      \end{enumerate}
   \end{myIndent}}
   ...
   {\begin{myIndent} \hTwo
      Fact: $\mathbb{R}$ is the smallest complete metric space containing $\mathbb{Q}$. \retTwo
   \end{myIndent}}
   ...
   {\begin{myIndent} \hTwo
      ...
      \begin{itemize}
         ...
         {\begin{myIndent}\hThree
            Proof:\\
            Let $\varepsilon > 0$. Then $\frac{1}{n^p} < \varepsilon$ whenever $(\frac{1}{\varepsilon})^\frac{1}{p} < n$
            \retTwo
         \end{myIndent}}
         ...
         {\begin{myIndent}\hThree
            ...
            by the\\ binomial theorem: $1 + nx_n \leq (x_n + 1)^n = 1 + nx_n + \ldots = p$. This means that $0 < x_n \leq (p - 1)\frac{1}{n}$.\retTwo
            Using proposition 33.3 and the limit found above, we have that\\ $\frac{p-1}{n}\rightarrow 0$. And as each $x_n \leq \frac{p-1}{n}$, we thus know by proposition 33.3 that $0 < \lim\limits_{n\rightarrow\infty}{(x_n)} \leq 0 \Longrightarrow x_n \rightarrow 0$. Hence, $\sqrt[n]{p} = x_n + 1 \rightarrow 0 + 1 = 1$ 
            \retTwo
         ...
         {\begin{myIndent}\hThree
            ...
            $\sqrt{\frac{2}{n-1}} = \sqrt{2}\frac{1}{(n-1)^\frac{1}{2}} < \sqrt{2}\frac{1}{(n)^\frac{1}{2}}$.
            \retTwo
         \end{myIndent}}
   ...
   \begin{allowTableDashes}
      \begin{tabular}{ c|c||c|c }
         ...
         \myVS 43 & 3.20 & 44 &  \\ \hdashline[10pt/3pt]
