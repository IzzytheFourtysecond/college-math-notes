...
\begin{document}
      ...
      \begin{itemize}
         ...
         \begin{itemize}
            ...
            {\begin{myTindent} \teachComment
               $d_2(\mVec{x}, \mVec{y})=\lvert \mVec{x} - \mVec{y} \rvert$
            \end{myTindent}}
   ...
   Note that in this class, unless it is mentioned other wise, you can assume that we are equipping $\mathbb{R}$ or $\mathbb{R}^k$ with the \udefine{Euclidean} metric: $d_2$.
