...
\begin{myIndent}\exTwoP
	First we show $\rho$ is a metric. To start, a reccuring relevant fact is that $\frac{|f - g|}{1 + |f - g|} \geq 0$. So:
...
\blab{Exercise 2.34}: Suppose $|f_n| \leq g \in L^1$ and $f_n \rightarrow f$ in measure.
