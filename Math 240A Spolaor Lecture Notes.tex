...
\blab{Exercise 1.21:} Let $\mu^*$ be an outer measure induced from a premeasure and $\overline{\mu}$ be the\\ restriction of $\mu^*$ to the $\mu^*$-measurable sets. Then $\overline{\mu}$ is saturated.
