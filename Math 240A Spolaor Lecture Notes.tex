...
\begin{itemize}
   ...
   \item $\mu$ is called \udefine{semifinite} if $\forall E \in \mathcal{M}$ with $\mu(E) = \infty$, there exists $F \subseteq E$ such that $F \in \mathcal{M}$, and $\mu(F) < \infty$.\retTwo
\end{itemize}
