...
{\begin{myIndent} \hTwo
   ...
   \begin{itemize}
      ...
      {\begin{myIndent}\hThree
         ...
         Hence, $\frac{\|\mVec{x}\|}{\|\mMat{A}^{-1}\|} \leq \|\mMat{B} - \mMat{A}\|\|\mVec{x}\| + \|\mMat{B}(\mVec{x})\|$. By rearranging terms, we get\\ this expression: $\left(\frac{1}{\|\mMat{A}^{-1}\|} - \|\mMat{B} - \mMat{A}\|\right)\|\mVec{x}\| \leq \|\mMat{B}(\mVec{x})\|$.
      ...
      {\begin{myIndent}\hThree
         ...
         {\centering $\lim\limits_{\|\mMat{B} - \mMat{A}\| \rightarrow 0}\left(\frac{\|\mMat{A}^{-1}\|^2}{1 - \|\mMat{A}^{-1}\|\|\mMat{B} - \mMat{A}\|}\|\mMat{B} - \mMat{A}\|\right) = \|\mMat{A}^{-1}\|^2 \cdot 0 = 0$.\retTwo\par}

         So, $0 \leq \hspace{-0.8em} \lim\limits_{\vphantom{\int^{b}}\|\mMat{B} - \mMat{A}\| \rightarrow 0}\hspace{-0.6em}(\|\mMat{B}^{-1} - \mMat{A}^{-1}\|) \leq 0$.
         
         \newpage
         
         This means that $\|\mMat{B}^{-1} - \mMat{A}^{-1}\| \rightarrow 0$ as $\|\mMat{B} - \mMat{A}\| \rightarrow 0$. Or in other words:

         {\center $\phantom{\blacksquare\text{.}}$ $\lim\limits_{\mMat{B} \rightarrow \mMat{A}}(\mMat{B}^{-1}) = \mMat{A}^{-1}$. $\blacksquare$ \retTwo\par}
      \end{myIndent}}
   \end{itemize}
\end{myIndent}}
