...
Also, if $A \subseteq \mathbb{R}^p$ is the union of a finite number of intervals, we say $A$ is an\\ \udefine{elementary set}.\retTwo
...
{\begin{myIndent}\exOne
   Claim: $\mathcal{E}$ is a ring but not a $\sigma$-ring.
   ...
   {\begin{myIndent}\exTwo
      ...
      \begin{myIndent}
         ...
         Meanwhile, to show that $A - B \in \mathcal{E}$, let's first show that the\\ set difference of two intervals . Let $I = [a_1, b_1] \times [a_2, b_2] \times \ldots \times [a_p, b_p]$ and\\ $J = [c_1, d_1] \times [c_2, d_2] \times \ldots \times [c_p, d_p]$.
      \end{myIndent}
      \retTwo
   \end{myIndent}}
\end{myIndent}}

Also, given any interval $I \in \mathbb{R}^p$ defined by the constants $a_i, b_i$ for $i \in \{1,\ldots, p\}$,\\ we define:\\ [-18pt]

{\centering $m(I) = \prod\limits_{i=1}^p(b_i - a_i)$.\\ [-1pt]\par} 
