...
{\begin{myIndent}\hTwo
   ...
   {\begin{myIndent}\hThree
      ...
      Now, since $f \in \mathscr{C}^1$, we know that for any $\varepsilon > 0$, there exists $\delta > 0$ such\\ that $\|\mVec{y} - \mVec{x}\| < \delta \Longrightarrow \|f^\prime(\mVec{x}) - f^\prime(\mVec{x})\| < \varepsilon$. Thus, by the above\\ inequality, we also have that:
...
{\begin{myIndent}\hTwo
   ...
   {\begin{myIndent}\hThree
      ...
      Now consider that for any $m, n \in \mathbb{Z}^+$ such that $m > n \geq 1$, we\\ have that:
...
{\begin{myIndent}\hTwo
   ...
   \begin{itemize}
      ...
      \item[(B)] If $g$ is defined such that $(g \circ f)(\mVec{x}) = \mVec{x}$ for all $x \in U$, then\\ $g \in \mathscr{C}^{1}(V, \mathbb{R}^n)$.\retTwo
   \end{itemize}
   ...
   {\begin{myIndent}\hThree
      ...
      At the same, from part A we know that $\|\varphi(\mVec{x} + \mVec{h}) - \varphi(\mVec{x})\| < \frac{1}{2}\|\mVec{h}\|$.\\ Therefore, we have $\|\mVec{h} - \mMat{A}^{-1}\mVec{k}\| \leq \frac{1}{2}\|\mVec{h}\|$.
   \end{myIndent}}
\end{myIndent}}
