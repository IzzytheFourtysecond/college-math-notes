...
{\begin{myIndent} \hTwo
   ...
   \begin{myIndent}
      \color{BrickRed}%
      The proof in class for this was very long and glossed over a lot of details\\ because most of us in the class don't know enough math to do the entire\\ proof yet. So, I'm just going to skip writing it down.
   \end{myIndent}
\end{myIndent}}
