...
{\begin{myIndent} \hTwo
   ...
   {\begin{myIndent} \hThree
      ...
      Obviously, $\lvert S^+ \rvert \leq \lvert S \rvert$ and $\lvert S^- \rvert \leq \lvert S \rvert$ as all vertices except the first and last vertex of $P$ have exactly one vertex before and after them in $P$. Also note that $N(S) \subseteq S^+ \cup S^-$. This is because for any $s \in S$ and $w \in N(s)$, we can do a rotation at $s$ to get another element of $s$ either directly after $w$ or directly before $w$.
