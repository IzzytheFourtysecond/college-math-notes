...
{\begin{myIndent}\hTwo
   ...
   {\begin{myIndent} \hThree
      ($\Longrightarrow$) Suppose we have a 3-connected cubic planar graph $G_0$. Then consider the maximal plane graph $G_1$ with all the vertices and edges of $G_0$. \retTwo
