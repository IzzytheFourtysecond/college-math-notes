...
{\begin{myIndent} \hTwo
   ...
   {\begin{myIndent} \hFour
      Proof:\\
      Obviously, $r_1(3) = 3 = \lfloor e\cdot k! \rfloor + 1$. So, let us now $k$-color $E(K_N)$ and proceed by induction on $k$ such that $k > 2$.\retTwo
      ...
      {\center $ a_k \leq \frac{k!}{k!} + \frac{k!}{(k-1)!}a_{k-1} \leq \frac{k!}{k!} + \frac{k!}{(k-1)!} + \frac{k!}{(k-2)!}a_{k-2} \leq \cdots \leq \sum\limits_{i=1}^k\frac{k!}{i!} \leq e\cdot k!$\retTwo\par}
...
Question: In a digraph with capacities and a source and sink, what is the maximum value of a flow?

{\begin{myIndent} \hTwo
   Let $(S, T)$ be an ordered pair of sets partitioning $V(G)$. The \udefine{capacity of a cut} is defined as: $c(S, T) = \hspace{-0.2em}\sum\limits_{
   \begin{smallmatrix}
      v \in S \\
      w \in T
   \end{smallmatrix}}\hspace{-0.1em}c(v, w)$.\retTwo
