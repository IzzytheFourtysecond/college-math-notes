...
Let $G$ be a plane graph. Then the faces of $G$ are the maximal connected regions of $\mathbb{R}^2 \setminus G$.
...
{\center \exOne
   \begin{myClosureOne}{4}
      ...
      {\center\raisebox{-1em}{\tikz[scale=0.5,inner sep=5pt]{
...
{\begin{myIndent} \hTwo
   \uuline{Handshaking Lemma}: If $F(G)$ is the set of faces of a plane graph $G$, then: \[\sum_{f \in F(G)}{\text{degrees}(f)} = 2|E(G)|\]
\end{myIndent}}
