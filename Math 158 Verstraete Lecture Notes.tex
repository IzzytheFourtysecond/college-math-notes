...
{\begin{myIndent} \hTwo
   ...
   \begin{myIndent}
      Proof:\\
      If $G$ is planar, then $|E(G)| \leq 3|V(G)| - 6$. However,\\ ${\displaystyle \sum_{v\in V(G)}{d_G(v)} = 2|E(G)| \leq 6|V(G)| - 12 < 6|V(G)|}$.\retTwo So not every vertex in $G$ can have a a degree of $6$ or more. \retTwo
   \end{myIndent}}
\end{myIndent}}
