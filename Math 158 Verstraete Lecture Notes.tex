...
One application of Hall's Theorem is the "systems of distinct representatives"

\end{document}


In particular, if $\lvert A \rvert = \lvert B \rvert$, then $G$ has a perfect matching.